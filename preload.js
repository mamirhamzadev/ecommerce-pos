...
contextBridge.exposeInMainWorld('api', {
  ...
  setCustomerTag: (payload) => invoke('tags:set', payload),
  listInvoicesPaged: (payload) => invoke('invoices:listPaged', payload),
  listInvoiceIds: (payload) => invoke('invoices:listIds', payload),
  listInvoicesByIds: (payload) => invoke('invoices:listByIds', payload),
